...
private:
    ...
    std::mutex server_mutex_;    // HTTP server socket management
#ifdef _WIN32
...
public:
    ...
    bool start();
    void stop();
    bool is_running() const { return running_.load(); }    // Endpoint registration
...
private:
    // Core HTTP server implementation    void worker_thread();    void server_loop();
#ifdef _WIN32
